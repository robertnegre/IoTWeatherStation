...
def determine_forecast(humidity, temperature, pressure, altitude, rain):
    ...
    global red_led_status, blue_led_status, green_led_status, yellow_led_status
    # Reset status
    red_led_status = False
    blue_led_status = False
    green_led_status = False
...
while True:
    ...
    data = {
        ...
        "Rain Status" : rain,
        "Yellow Led Status" : yellow_led_status,
        "Red Led Status" : red_led_status,
        "Blue Led Status" : blue_led_status,
        "Green Led Status": green_led_status
        }
